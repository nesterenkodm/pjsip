...
LICENSE
  ...
  s.subspec 'pjsip' do |sub|
    sub.public_header_files = 'pjproject-2.2.1/pjsip/include/**'
  ...
  s.subspec 'pjlib' do |sub|
    sub.public_header_files = 'pjproject-2.2.1/pjlib/include/**'
  ...
  s.subspec 'pjlib_util' do |sub|
    sub.public_header_files = 'pjproject-2.2.1/pjlib-util/include/**'
  ...
  s.subspec 'pjnath' do |sub|
    sub.public_header_files = 'pjproject-2.2.1/pjnath/include/**'
  ...
  s.subspec 'pjmedia' do |sub|
    sub.public_header_files = 'pjproject-2.2.1/pjmedia/include/**'
